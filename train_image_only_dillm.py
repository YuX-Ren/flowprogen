...
class MemoryEfficientEMA:
    ...
    # 添加 return_only_pred_flows 方法，以兼容 LLMfusion 的期望
...
if local_rank == 0:
    try:
        rmtree('./results/train_image_only_dillm', ignore_errors = True)
        results_folder = Path('./results/train_image_only_dillm')
