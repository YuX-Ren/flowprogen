...
rmtree('./results_llmflow/train_latent_only_dillm', ignore_errors = True)
results_folder = Path('./results_llmflow/train_latent_only_dillm')
...
# 在创建 LLMFlow 模型之前，将默认数据类型设置回 float16
# torch.set_default_dtype(torch.float32)
