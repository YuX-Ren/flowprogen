...
from cheap.pretrained import CHEAP_shorten_2_dim_32
...
class DecodeLatent:
    ...
    def __init__(
        ...
        self.hourglass = CHEAP_shorten_2_dim_32(return_pipeline=False)
    ...
    def construct_sequence(
        ...
        with torch.no_grad():
            _, _, sequences = self.sequence_constructor.to_sequence(
    ...
    def run(self, x):
        ...
        # print(
        #     f"Constructing structures and writing to {str(self.output_root_dir / 'structures')}"
        # )
        start = time.time()
